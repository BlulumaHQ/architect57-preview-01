...
import herbalandNewProduction01 from "@/assets/herbaland_new_production-01.webp";
import hazcoEnvironmentalWaste01 from "@/assets/hazco_environmental_waste-01.webp";
...
export const allProjects: ProjectItem[] = [
  // ── RESIDENTIAL ──────────────────────────────────────
  {
    ...
    isFeatured: true,
    description: "A distinguished custom residence set against the dramatic topography of West Vancouver. The design leverages natural grade changes to create layered living spaces with expansive views toward the ocean and mountains. Recognized as a finalist for the CHBA National Awards for Housing Excellence.",
    details: [
  ...
  },
  {
    ...
    isFeatured: true,
    description: "A generously proportioned family residence in Delta, designed in collaboration with interior designer John Han. The home balances contemporary form with warm materiality, creating spaces that feel both refined and inviting.",
    details: [
      { label: "Category", value: "Residential" },
  ...
  },
  {
    ...
    image: severnResidence01,
    images: [severnResidence01],
    isFeatured: true,
    description: "A custom single-family residence in Richmond that embodies clean contemporary lines and thoughtful spatial planning. The design prioritizes natural light and flow between interior living spaces and outdoor areas.",
    details: [
      { label: "Category", value: "Residential" },
  ...
  },
  {
    ...
    isFeatured: true,
    description: "A refined single-family home in Richmond designed to maximize livable space within a considered footprint. The residence features a clean material palette and efficient spatial organization.",
    details: [
      { label: "Category", value: "Residential" },
      { label: "Location", value: "Richmond, BC" },
  ...
  },
  {
    ...
    title: "Cartier Residence",
    category: "Residential",
    tags: ["Custom Home"],
    location: "Vancouver, BC",
    image: cartierResidence01,
  },
  {
    slug: "laurel-residence",
    title: "Laurel Residence",
    category: "Residential",
    tags: ["Custom Home"],
    location: "Vancouver, BC",
    image: laurelResidence01,
  },
  // Multiplex (under Residential)
  {
    slug: "collingwood",
    title: "Collingwood",
    category: "Residential",
    ...
    isFeatured: true,
    description: "A contemporary multi-unit housing development in Vancouver's Collingwood neighbourhood, contributing thoughtfully to the area's increasing urban density. The design balances privacy between units with shared landscape amenity.",
    details: [
      { label: "Category", value: "Residential" },
      { label: "Location", value: "Vancouver, BC" },
      { label: "Area", value: "10,500 sq. ft." },
      { label: "Budget", value: "$5 millions" },
    ],
  },
  {
    slug: "royal-oak",
  ...
  },
  {
    ...
    tags: ["Condo"],
    location: "Langley, BC",
    detail: "12-storey with underground parking",
  ...
  },
  {
    ...
    isFeatured: true,
    description: "A significant commercial office development in Richmond's Bridgeport district, designed to accommodate modern workplace needs within a refined architectural envelope. The building's massing responds to the urban context while maximizing efficient floor plates and natural light penetration.",
    details: [
      { label: "Category", value: "Commercial" },
      { label: "Location", value: "Richmond, BC" },
      { label: "Area", value: "28,703 sq. ft." },
      { label: "Budget", value: "$10 millions" },
    ],
  },
  {
    slug: "wellington-mixed-use",
    title: "Wellington Mixed-Use",
    category: "Commercial",
    tags: ["Mixed-use"],
  ...
  {
    slug: "54th-ave-condo-4",
    title: "54th Ave Condo (4-Storey)",
    category: "Commercial",
    tags: ["Condo"],
    location: "Langley, BC",
    detail: "4-storey with underground parking",
    image: fiftyFourthAveCondo01,
  },
  {
  ...
  // ── INDUSTRIAL ───────────────────────────────────────
  {
    slug: "rayacom-super-print-factory",
    title: "Rayacom Super Print Factory",
    category: "Industrial",
    tags: ["Manufacturing"],
    location: "Vancouver, BC",
    area: "128,285 sq. ft.",
  ...
  },
  {
    ...
    title: "Trouw Frankie Feed Mill",
    category: "Industrial",
    tags: ["Heavy Industrial"],
    location: "Chilliwack, BC",
    detail: "Design engineer: CMC Engineering",
    image: trouwFrankieFeedMill01,
  },
  {
    slug: "ontario-storage-warehouse",
    title: "Ontario Storage Warehouse",
    category: "Industrial",
    tags: ["Warehouse"],
    location: "Vancouver, BC",
    image: ontarioStorageWarehouse01,
  },
  {
    slug: "brightway-cfia-seafood",
    title: "Brightway CFIA-Certified Seafood Processing Upgrade",
    category: "Industrial",
  ...
  },
  {
    ...
    title: "Atlas Power Technologies Inc.",
    category: "Industrial",
    tags: ["Manufacturing"],
    location: "Abbotsford, BC",
    area: "19,579 sq. ft.",
    image: atlasPowerTechnologies01,
  },
  {
    slug: "greenlight-innovation",
    title: "Greenlight Innovation",
    category: "Industrial",
    tags: ["Energy"],
    location: "Burnaby, BC",
    area: "48,756 sq. ft.",
    detail: "Designer: SSDG Interiors Inc.",
    image: greenlightInnovation01,
  },
  {
    slug: "corvus-energy-expansion",
    title: "Corvus Energy Expansion",
    category: "Industrial",
    tags: ["Energy"],
    location: "Richmond, BC",
    area: "33,828 sq. ft.",
  ...
  },
  {
    ...
    title: "Rayacom Premium Print Upgrade",
    category: "Industrial",
    tags: ["Manufacturing"],
    location: "Vancouver, BC",
    area: "32,675 sq. ft.",
    image: rayacomPremiumPrint01,
  },
  {
    slug: "sunwins-surgical-mask",
    title: "Sunwins Surgical Mask Factory",
    category: "Industrial",
    tags: ["Cleanroom"],
    location: "Vancouver, BC",
    detail: "Cleanroom level 5 ready",
    image: sunwinsSurgicalMask01,
  },
  {
    slug: "herbaland-new-production",
    title: "Herbaland New Production Plant",
    category: "Industrial",
    tags: ["Production"],
    location: "Richmond, BC",
    area: "43,601 sq. ft.",
  ...
  {
    slug: "hazco-environmental-waste",
    title: "Hazco Environmental Waste Transfer Station",
    category: "Industrial",
    tags: ["Waste Processing"],
    location: "Richmond, BC",
    area: "29,925 sq. ft.",
    image: hazcoEnvironmentalWaste01,
  },

  // ── INSTITUTIONAL ────────────────────────────────────
  {
    slug: "east-2nd-avenue",
    title: "East 2nd Avenue",
  ...
  },
  {
    ...
    details: [
      { label: "Category", value: "Institutional" },
      { label: "Location", value: "Richmond, BC" },
  ...
  },
  {
    ...
    title: "Katalin Care Homes",
    category: "Institutional",
    tags: ["Healthcare", "Senior Care"],
    location: "Mission, BC",
    area: "6,225 sq. ft.",
    image: katalinCareHomes01,
  },
  {
    slug: "okanagan-chateau-retirement",
    title: "Okanagan Chateau Retirement Residence",
    category: "Institutional",
    tags: ["Senior Care", "Renovation"],
    location: "Kelowna, BC",
    detail: "Interior renovation",
    image: okanaganChateauRetirement01,
  },
  {
    slug: "mariposa-gardens-retirement",
    title: "Mariposa Gardens Retirement Residence and Care",
    category: "Institutional",
    tags: ["Senior Care"],
    location: "Osoyoos, BC",
    area: "109,487 sq. ft.",
    detail: "Plumbing upgrade",
    image: mariposaGardensRetirement01,
  },
  {
    slug: "sienna-rideau-retirement",
    title: "Sienna Rideau Retirement Residence",
    category: "Institutional",
    tags: ["Senior Care"],
    location: "Burnaby, BC",
    detail: "Interior renovation + fire sprinkler upgrade; 19 storeys",
    image: siennaRideauRetirement01,
  },

  // ── COMMUNITY & CULTURAL ─────────────────────────────
  {
    slug: "gold-buddha-monastery",
    title: "Gold Buddha Monastery Expansion",
    category: "Community & Cultural",
    tags: ["Religious", "Temple"],
    location: "Vancouver, BC",
    area: "33,034 sq. ft.",
  ...
  },
  {
    ...
    title: "Lutheran Community Church Expansion",
    category: "Community & Cultural",
    tags: ["Religious", "Church"],
    location: "Las Vegas, NV",
    image: lutheranCommunityChurch01,
  },
  {
    slug: "iglesia-ni-cristo-locale",
    title: "Iglesia Ni Cristo Locale of Surrey",
    category: "Community & Cultural",
    tags: ["Religious"],
    location: "Surrey, BC",
    area: "10,964 sq. ft.",
  ...
  },
  {
    ...
    title: "Treasure Cove Casino Expansion",
    category: "Community & Cultural",
    tags: ["Casino"],
  ...
  {
    slug: "atomic-fitness",
    title: "Atomic Fitness",
    category: "Community & Cultural",
    tags: ["Fitness"],
    location: "Richmond, BC",
    image: atomicFitness01,
  },
  {
  ...
  {
    slug: "appliance-canada",
    title: "Appliance Canada",
    category: "Interior Projects",
    tags: ["Retail"],
    location: "Richmond, BC",
    area: "11,639 sq. ft.",
  ...
  },
  {
    ...
    title: "Beresford Doctor Clinic",
    category: "Interior Projects",
    tags: ["Medical"],
    location: "Burnaby, BC",
    image: beresfordDoctorClinic01,
  },
  {
    slug: "willingdon-green-clinic",
    title: "Willingdon Green Clinic",
    category: "Interior Projects",
    tags: ["Medical"],
    location: "Burnaby, BC",
    image: willingdonGreenClinic01,
  },
  {
    slug: "teco-office",
    title: "Teco Office",
  ...
  },
  {
    ...
    category: "Interior Projects",
    tags: ["Retail"],
    location: "Tsawwassen Mills Mall, Delta, BC",
    image: adore01,
  },

  // ── MASTER PLANNING ──────────────────────────────────
  {
    slug: "zone-5-union-bay-estate",
    title: "Zone 5, Union Bay Estate",
    category: "Master Planning",
    tags: ["Planning"],
    location: "Union Bay, BC",
    area: "1,189,000 sq. ft. (27.30 acres)",
    image: zone5UnionBay01,
  },
  {
    slug: "new-university-hospital-northern-bc",
    title: "New University Hospital of Northern BC Building Construction Phase Planning",
    category: "Master Planning",
    tags: ["Planning", "Healthcare"],
    location: "Prince George, BC",
    area: "277,000 sq. ft.",
    budget: "$700 millions",
  ...
  {
    slug: "dubai-house-of-the-future",
    title: "Dubai House of the Future Competition",
    category: "Master Planning",
    tags: ["Concept", "Competition"],
    area: "570,000 sq. ft. (13.09 acres)",
    image: dubaiHouseOfFuture01,
  },
];

// Featured projects (have detail pages)
